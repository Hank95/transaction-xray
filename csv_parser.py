...
class CSVParser:
    ...
    def _categorize_transaction(self, description: str) -> str:
        ...
        categories = {
            'Income': ['payroll', 'salary', 'interest paid'],
            ...
            'Subscriptions': ['membership fee', 'spotify', 'netflix', 'hulu', 'apple music', 'youtube premium', 'apple.com/bill'],
            'Insurance': ['geico', 'state farm', 'progressive', 'bcbs', 'blue cross', 'insurance'],
            ...
            'Shopping': ['amazon', 'target', 'walmart', 'retail', 'store', 'shop',
                        'mall', 'lululemon', 'j crew'],
            'Gas': ['circle k', 'shell', 'exxon', 'bp', 'chevron', 'gas', 'fuel', 'mobil', 'citgo', 'marathon'],
            'Transportation': ['uber', 'lyft', 'transit', 'parking', 'toll', 'ultrasignup'],
            ...
            'Transfer': ['autopay payment', 'applecard gsbank', 'amex epayment', 'amex dps',
                        'venmo', 'zelle', 'check number', 'check deposit',
                        'funds transfer', 'transfer to schwab', 'overdraft transfer',
                        'capital one', 'pmt*charleston', 'platinum lululemon credit'],
        }
